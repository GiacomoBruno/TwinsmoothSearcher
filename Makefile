...
all: main.cpp nb.o logger.o file_manager.o tree.o static_twinsmooth.o twinsmooth.o prime_calculator.o prime_calculator_top_n.o twinsmooth_range.o twinsmooth_k.o twinsmooth_k_growing.o twinsmooth_range_growing.o twinsmooth_test.o
